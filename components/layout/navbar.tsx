  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 w-full pt-4 px-4">
      <div className="relative h-[48px] max-w-6xl mx-auto">
        ...
        <div
          className={cn(
            "relative z-30 h-full px-5 flex items-center justify-between transition-all duration-700",
            showTypewriter
        ...
        >
          {/* LEFT — LOGO */}
          <div className="relative w-9 h-9 overflow-hidden rounded-full border border-white/20 shadow-md">
            <Image
